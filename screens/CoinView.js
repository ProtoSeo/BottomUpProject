    ...
    return(
      ...
      <View>
        ...
        <ScrollView >
          ...
          <GradientButton style={{ marginVertical: 8 ,marginLeft : 30}} text="대전/충청" width='80%' deepBlue impact />
          <GradientButton style={{ marginVertical: 8 ,marginLeft : 30}} text="광주/전라" width='80%' deepBlue impact />
          <GradientButton style={{ marginVertical: 8 ,marginLeft : 30}} text="대구/경북" width='80%' deepBlue impact />
          <GradientButton style={{ marginVertical: 8 ,marginLeft : 30}} text="부산/경남" width='80%' deepBlue impact />
          <GradientButton style={{ marginVertical: 8 ,marginLeft : 30}} text="강원도" width='80%' deepBlue impact />
          <GradientButton style={{ marginVertical: 8 ,marginLeft : 30}} text="제주특별자치시" width='80%' deepBlue impact />
        </ScrollView>
        </View>
